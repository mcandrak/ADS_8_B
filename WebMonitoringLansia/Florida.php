    ...
    <div class="container">
      ...
      <div id="test1" class="col s12">
        <div class="container">
          ...
          <p align="center">Rumah ID 54202HU - ID 65614BS - Beautiful Room
            <br>Tempat Tidur : 5 ruang
            <br>Kamar Mandi : 5 ruang
            <br>Lantai : 2
            <br>+ Garasi Mobil
            <br>
            <br>Tentang Rumah - F l o r i d a 
          </p>
          <p align="justify">
      ...
      <div id="test2" class="col s12">
          <div class="container">
              ...
              <div class="row">
                  <div class="col s6">
                      <center><img class="materialboxed col s12" data-caption="rumah sederhana" src="img/florida/d.gif"></center>
                  </div>
              </div>
          </div>
      </div>
