...
<body>
  ...
  <div id="index-banner">
    <div class="section no-pad-bot" >
      <div class="container">
        <h2 class="center green-text"><strong>A C A D I A N</strong></h2>
        <!-- gambar rumah -->
        <center><img src="img/acadian/1_a.jpg"></center>
        <!-- end gambar rumah -->
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div id="test1" class="col s12">
        <div class="container">
          ...
          <h5 class="center light flow-text"> A c a d i a n</h5>
          <p align="center">Rumah ID 56352SM - French Country Home 
		        <br>Tempat Tidur : 4 ruang
		        <br>Kamar Mandi : 2 ruang
		        <br>Lantai : 2
		        <br>+ Garasi Mobil
		        <br>
		        <br>Tentang Rumah - A c a d i a n
          </p>
		      <p align="justify">
		          Rumah Perancis ini memberikan Anda 4 kamar tidur yang terletak pada lantai satu ( 2 kamar ) dan lantai dua ( 2 kamar ) tepat diatas ruang garasi.
		          Rumah ini memiliki langit-langit & lemari yang klasik.
		          Ruang "foyer" akan membuat Anda menikmati pemandangan langsung melalui ke belakang rumah.
		          Ruang keluarga memiliki perapian terbuka untuk dapur dan ruang makan. 
		          Terdapat sepasang pintu Prancis yang mengarah pada teras belakang yang cukup unik yang untuk digunakan sebagai ruang hidup di luar ruangan.
		          Ruangan "foyer" terdapat sebuah tempat tidur yang dapat digunakan sebagai kamar tidur tamu dalam keadaan darurat.
		      </p>
        </div>
      </div>
	    <div id="test2" class="col s12">
              ...
              <h5 class="center light flow-text"> A c a d i a n</h5><br><br>
              <div class="row">
                  <div class="col s6">
                      <center><img class="materialboxed col s12" data-caption="rumah sederhana" src="img/acadian/d_1.gif"></center>
                  </div>
                  <div class="col s6">
                      <center><img class="materialboxed col s12" data-caption="rumah sederhana" src="img/acadian/d_2.gif"></center>
                  </div>
              </div>
	        </div>
      </div>
        ...
        <br>
          <div class="container">
            <div class="slider">
              <ul class="slides">
                <li>
                  <img src="img/acadian/3.jpg"> <!-- random image -->
                </li>
                <li>
                  <img src="img/acadian/3_2.jpg"> <!-- random image -->
                </li>
                <li>
                  <img src="img/acadian/3_1.jpg"> <!-- random image -->
                </li>
              </ul>
            </div>
          </div>
      ...
      <div id="test5" class="col s12">
        <div class="container">
          ...
          <h6 class="center lighten-1 flow-text">For Acadian</h6>
          <div class="row" >
